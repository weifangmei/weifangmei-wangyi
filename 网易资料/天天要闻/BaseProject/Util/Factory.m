...
+ (void)addMenuItemToVC:(UIViewController *)vc{
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"top_navi_bell_normal"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"top_navi_bell_highlight"] forState:UIControlStateHighlighted];
